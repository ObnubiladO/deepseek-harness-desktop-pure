 ...
 * a pure composition face — slot-owned content (trigger and optional update
 * seats, panel title, close label, sections) arrives from registrants through
 * slots; accessible names resolve from localized content (trigger: shell
 * locale; dialog:
