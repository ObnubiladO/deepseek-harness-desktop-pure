...
Every synchronization note and adaptation document names the exact upstream tag or commit it covers (for this cycle: `dsh-v0.1.7-rc.2`, version `0.1.7-rc.2`). This traceability does not change the independent Desktop version.
