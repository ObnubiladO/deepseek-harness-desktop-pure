...
Every synchronization note and adaptation document names the exact upstream tag or commit it covers (for this cycle: `dsh-v0.1.6-alpha.1`, version `0.1.6-alpha.1`). This traceability does not change the independent Desktop version.
