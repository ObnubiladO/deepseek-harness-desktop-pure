/**
 * Acceptance coverage for the rescope codemod: recorded npm evidence stays intact while
 * authored files and exact edits remain checked, including idempotency failures and the
 * repository's intentional prose pairs.
 */
